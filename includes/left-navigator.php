      ...
      <div class="position-sticky pt-3">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
             ...
             <a class="nav-link" data-bs-toggle="collapse" role="button" data-bs-target="#target_nav" aria-expanded="<?php   echo $_getParam['form']=='target_mgmt'||$_getParam['form']=='target_report'?"true":'false'; ?>" aria-controls="target_nav" >
              <span data-feather="target"></span>
            Target/Commitment
            </a> 
              <div class="collapse <?php   echo $_getParam['form']=='target_mgmt'||
                      $_getParam['form']=='target_report'?"show":''; ?>" id="target_nav">
             ...
             &nbsp;   <span data-feather="edit"></span>
              Modify Target
                               ...
                               <li class="nav-item">
                                   <a class="nav-link <?php   echo $_getParam['form']=='target_report'?"active":''; ?>" href="./?<?php echo base64_encode("form=target_report"); ?>">
